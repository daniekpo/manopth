...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--random_shape", action="store_true", help="Random hand shape"
    )
    parser.add_argument(
        "--rand_mag", type=float, default=1, help="Controls pose variability"
    )
    parser.add_argument(
        "--flat_hand_mean",
        action="store_true",
    ...
    parser.add_argument(
        "--root_rot_mode", default="axisang", choices=["rot6d", "axisang"]
    )
    parser.add_argument(
        "--no_pca",
        action="store_true",
    ...
    pose_params = args.rand_mag * torch.rand(
        args.batch_size, args.mano_ncomps + rot
    )
